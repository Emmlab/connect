...
import { developerGithubLoginAction, developerGithubLoginCallbackAction } from '@/utils/actions/'
...
const GithubAuthButton = () => {
  ...
  useQuery({
    ...
    queryFn: () => developerGithubLoginCallbackAction(callbackParams)
      .then((result) => {
        if (result?.$id) {
  ...
  const { mutate: mutateDeveloperGithubLogin, isPending: isPendingDeveloperGithubLogin } = useMutation({
