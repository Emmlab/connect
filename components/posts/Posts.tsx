...
const Posts = () => {
  ...
  if (isPending) return <div className="flex flex-col gap-4 mt-4">
    <PostCardSkeleton />
    <PostCardSkeleton />
    <PostCardSkeleton />
  </div>;
  ...
  if (posts.length < 1) return <div className="flex flex-col justify-center rounded-md border mt-4 pt-12 pb-12">
      <div className='flex gap-x-2 mx-auto my-2'>
        <CornerLeftUp className="animate-bounce" /> <span className='capitalize mt-2'>Create Post</span>
      </div>
  </div>;
