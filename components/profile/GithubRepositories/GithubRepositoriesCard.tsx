 ...
 */
const GithubRepositoriesCard = ({ repositoryItem }: { repositoryItem: GithubDeveloperRepositoriesType }) => {
  type LanguagesIcons = {
        ...
        <CardTitle className="flex items-center gap-2 relative w-full">
          ...
          <div className="flex flex-col flex-grow relative">
            <div className="flex items-center justify-between w-full">
              <div className="line-clamp-1 text-base ">{repositoryItem.name || "Unknown"}</div>
              {language ?
