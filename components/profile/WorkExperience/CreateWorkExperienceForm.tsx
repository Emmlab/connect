...
const CreateWorkExperienceForm = () => {
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: (values: WorkExperienceFormType) => createWorkExperienceAction(values, dateRange),
    onSuccess: (data) => {
      if (!data) {
        toast({
    ...
    <Form {...form}>
      ...
      >
        <div className='flex flex-col gap-2'>
          ...
          <div className="">
            <CustomFormField placeholder="Your Company Name" name="company" control={form.control} />
            <CustomFormField placeholder="eg. Software Engineer" name="role" control={form.control} />
            <CustomFormField inputType="textarea" placeholder="Describe your role in the company" name="description" control={form.control} />
